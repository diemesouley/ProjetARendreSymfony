...
// Returns the private 'App\Repository\FraisRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FraisRepository.php';

return $this->privates['App\\Repository\\FraisRepository'] = new \App\Repository\FraisRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
