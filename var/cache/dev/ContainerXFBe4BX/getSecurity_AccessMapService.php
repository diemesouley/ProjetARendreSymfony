...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/user'), [0 => 'ROLE_SUPER_ADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/depot'), [0 => 'ROLE_CAISSIER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/partenaire'), [0 => 'ROLE_SUPER_ADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/transaction'), [0 => 'ROLE_USER_SIMPLE'], NULL);
