 ...
 */
class ComptePartenaire extends \App\Entity\ComptePartenaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ComptePartenaire' . "\0" . 'id', '' . "\0" . 'App\\Entity\\ComptePartenaire' . "\0" . 'numCompte', '' . "\0" . 'App\\Entity\\ComptePartenaire' . "\0" . 'soldeCompte', '' . "\0" . 'App\\Entity\\ComptePartenaire' . "\0" . 'dateCreation', '' . "\0" . 'App\\Entity\\ComptePartenaire' . "\0" . 'Partenaire', '' . "\0" . 'App\\Entity\\ComptePartenaire' . "\0" . 'depots', '' . "\0" . 'App\\Entity\\ComptePartenaire' . "\0" . 'users', '' . "\0" . 'App\\Entity\\ComptePartenaire' . "\0" . 'transactions'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ComptePartenaire $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setNumCompte(int $numCompte): \App\Entity\ComptePartenaire
    {
    ...
    public function getSoldeCompte(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSoldeCompte', []);

        return parent::getSoldeCompte();
    }

    /**
     * {@inheritDoc}
     */
    public function setSoldeCompte(int $soldeCompte): \App\Entity\ComptePartenaire
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSoldeCompte', [$soldeCompte]);

        return parent::setSoldeCompte($soldeCompte);
    }
     ...
     * {@inheritDoc}
     */
    public function setDateCreation(\DateTimeInterface $dateCreation): \App\Entity\ComptePartenaire
    {
     ...
     * {@inheritDoc}
     */
    public function setPartenaire(?\App\Entity\Partenaire $Partenaire): \App\Entity\ComptePartenaire
    {
     ...
     * {@inheritDoc}
     */
    public function addDepot(\App\Entity\Depot $depot): \App\Entity\ComptePartenaire
    {
     ...
     * {@inheritDoc}
     */
    public function removeDepot(\App\Entity\Depot $depot): \App\Entity\ComptePartenaire
    {
     ...
     * {@inheritDoc}
     */
    public function addUser(\App\Entity\User $user): \App\Entity\ComptePartenaire
    {
     ...
     * {@inheritDoc}
     */
    public function removeUser(\App\Entity\User $user): \App\Entity\ComptePartenaire
    {
     ...
     * {@inheritDoc}
     */
    public function addTransaction(\App\Entity\Transaction $transaction): \App\Entity\ComptePartenaire
    {
     ...
     * {@inheritDoc}
     */
    public function removeTransaction(\App\Entity\Transaction $transaction): \App\Entity\ComptePartenaire
    {
