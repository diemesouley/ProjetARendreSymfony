...
// Returns the private 'App\DataFixtures\SuperAdmin' shared autowired service.
...
return $this->privates['App\\DataFixtures\\SuperAdmin'] = new \App\DataFixtures\SuperAdmin(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
